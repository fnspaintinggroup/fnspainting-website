      ...
      <div className="mx-auto max-w-xl px-5 sm:px-6">
        <div className="rounded-2xl border border-ink/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-3 leading-7 text-ink/65">
            Select the record you want to enter. Each button opens the correct form.
          </p>
          ...
          <div className="mt-7 grid gap-4">
            ...
            <a
              ...
              href={siteRecordUrl}
            >
              <ClipboardCheck className="h-8 w-8 shrink-0" aria-hidden="true" />
              <span>
                <strong className="block text-lg">SITE WORK RECORD</strong>
                <span className="mt-1 block text-sm text-ink/60">
                  Daily work, completion or variation
                </span>
              </span>
            </a>
          </div>
          ...
          <div className="mt-6 flex gap-3 rounded-xl bg-mist p-4 text-sm leading-6 text-ink/65">
            ...
            <p>Site records are for approved F&amp;S team members only.</p>
          </div>
        </div>
      </div>
    </section>
